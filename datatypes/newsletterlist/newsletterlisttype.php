...
class NewsletterListType extends eZDataType
{
    ...
    function fetchClassAttributeHTTPInput( $http, $base, $classAttribute )
    {
        ...
        if ( $http->hasPostVariable( $base . "_geoaddress_showdata_" . $classAttribute->attribute( "id" ) ))
        {
            $data = $http->postVariable( $base . "_geoaddress_showdata_" . $classAttribute->attribute( "id" ) );
