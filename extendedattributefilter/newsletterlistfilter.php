<?php
/**
 * File containing NewsletterListFilter class
 *
...
class NewsletterListFilter
{
    ...
    function createSqlParts( $parameter )
    {
        ...
        if ( count( $siteAccessArray ) > 0 )
        {
            ...
            /*    $sqlHasCoordinate = "SELECT * FROM nl_list c, ezcontentobject e
            ...
            $sqlHasSiteAccess = "SELECT c.contentobject_id FROM nl_list c, ezcontentobject e
                                 WHERE e.id = c.contentobject_id
                                 AND e.current_version = c.contentobject_attribute_version
