<?php
/**
 * File containing the NewsletterBlacklistItem class
 *
 ...
 * @package newsletter
 */
class NewsletterBlacklistItem extends eZPersistentObject
{
     ...
     * @return void
     */
    function NewsletterBlacklistItem( $row )
    {
    ...
    static function definition()
    {
        return array( 'fields' => array( 'id' => array( 'name'     => 'Id',
                      ...
                      'class_name' => 'NewsletterBlacklistItem',
                      'name' => 'nl_blacklist_item' );
    }

    /**
     * fetch NewsletterBlacklistItem object by id
     * return false if not found
     *
     * @param integer $id
     * @param boolean $asObject
     * @return NewsletterBlacklistItem
     */
    public static function create( $email, $note )
    {
        $newsletterUserObject = NewsletterUser::fetchByEmail( $email );
        $newsletterUserId = 0;
        ...
        $object = new NewsletterBlacklistItem( $row );
        return $object;
    }
    ...
    /**
     * fetch NewsletterBlacklistItem object by email
    ...
    {
        $object = NewsletterBlacklistItem::fetchByEmail( $email );
        if( is_object( $object ) )
        {
            return true;
        }
    ...
    function getNewsletterUserObject()
    {
        ...
        {
            $user = NewsletterUser::fetch( $this->attribute( 'newsletter_user_id' ) );
            return $user;
        }
        else
        {
