<?php
/**
 * File containing the NewsletterMailComposer class
 *
 *
...
/**
 *  new Class NewsletterMailComposer because auf imageInclude problem of ezcMailComposer ezcomponents 1.7.1
 ...
 *
 *  Newsletter changes: only includes images from ezroot
 *
 * Example:
 * <code>
 ...
 * @mainclass
 */
class NewsletterMailComposer extends ezcMail
{
    /**
    ...
    private function generateHtmlPart()
    {
        ...
        if ( $this->htmlText != '' )
        {
            ...
            if ( $this->options->automaticImageInclude === true )
            {
                ...
                //  Newsletter regex change only find all  file://ezroot/
                // so it is secure
