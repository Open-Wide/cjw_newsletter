<?php
/**
 * File containing the NewsletterMailParser class
 *
...
class NewsletterMailParser
{
     ...
     * constructor
     *
     * @param NewsletterMailboxItem $rawMailContent
     * @return void
     */
    ...
    public function parse( )
    {
        ...
        if ( count( $ezcMailObjectArray ) > 0 )
        {
            ...
            $parsedMailHeaderArray = $this->getHeaders();

            // merge header arrays
            $parseArray = array_merge( $parsedMailInfosArray, $parsedMailHeaderArray );
            return $parseArray;
        }
        else
        {
