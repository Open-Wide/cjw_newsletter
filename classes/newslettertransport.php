<?php
/**
 * File containing the NewsletterTransport class
 *
    ...
    public function send( ezcMail $ezcMailComposerObject )
    {
        ...
        switch ( $iniTransport )
        {
            ...
            case 'file':
            {
                ...
                $transport = new NewsletterTransportFile( $mailDir );
            } break;
            case 'sendmail':
            case 'mta':
            {
        ...
        try
        {
            ...
            // NewsletterLog::writeInfo( 'email send ok', 'NewsletterTransport', 'send' );
        ...
        catch ( ezcMailTransportException $e )
        {
            ...
            eZDebug::writeError( 'NewsletterTransport:send: ' . $e->getMessage()  );
            return $e;
        }
    }
