        ...
        <div class="box-tc">
            <div class="box-ml">
                <div class="box-mr">
                    <div class="box-tl">
                        <div class="box-tr">
                            <h2 class="context-title">{'Newsletter edition preview archive'|i18n( 'newsletter/newsletter_edition_status' )}</h2>
                            {* DESIGN: Subline *}
                    ...
                    <div class="box-br">
                        <div class="box-content">
                            ...
                            <div class="mainobject-window">
                                ...
                                {include uri="design:includes/newsletteredition_preview_archive.tpl" newsletter_edition_attribute=$newsletter_edition_attribute show_iframes=$show_iframes height="100"}
                                <div class="break">
                                                        ...
                                                        <div class="block">
                                                            <div class="left">
                                                                ...
                                                                {if and( $node.can_remove,$node.data_map.newsletter_edition.content.is_draft )}
                                                                    <input class="button" type="submit" name="SendNewsletterButton" value="{"Send Newsletter"|i18n("newsletter/send")}"  onclick="return confirm('{'Do you really want to send out this newsletter to all recipients of this Newsletterlist?'|i18n( 'newsletter/newsletter_edition_preview' )}')" />
                                                                {/if}
