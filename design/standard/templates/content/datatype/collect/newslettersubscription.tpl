...
content/datatype/collect/newslettersubscription.tpl
*}
...
{/if}
    ...
    {if $newsletter_system_node_list|count|eq(0)}
        <p>
            {'No newsletters available.'|i18n( 'newsletter/datatype/newslettersubscription' )}
        </p>
    {else}
        ...
        {else}
                ...
                {/foreach}
{*
                <input class="halfbox" id="Subscription_Email" type="text" name="Subscription_Email" value="{$newsletter_user.email|wash}" title="{'Email of the subscriber.'|i18n( 'newsletter/datatype/newslettersubscription' )}" {cond( is_set( $newsletter_user ), 'disabled="disabled"', '')} />
*}
        {/if}
