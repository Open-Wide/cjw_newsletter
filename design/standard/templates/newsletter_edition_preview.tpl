        ...
        <div class="box-tc">
            <div class="box-ml">
                <div class="box-mr">
                    <div class="box-tl">
                        <div class="box-tr">
                            <h2 class="context-title">{'Newsletter edition preview'|i18n( 'newsletter/newsletter_edition_status' )}</h2>
                            {* DESIGN: Subline *}
                    ...
                    <div class="box-br">
                        <div class="box-content">
                            ...
                            <div class="mainobject-window">
                                ...
                                {include uri="design:includes/newsletteredition_preview.tpl" newsletter_edition_attribute=$newsletter_edition_attribute show_iframes=$show_iframes height="100"}
                                <div class="break">
