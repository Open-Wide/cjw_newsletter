...
{* Newsletter status *}
{include uri='design:newsletter_edition_status.tpl'}

{* Newsletter testmail *}
{include uri='design:newsletter_edition_send_testmail.tpl'}

{if $newsletter_edition_status|ne('draft')}
    {* Newsletter testmail *}
    {include uri='design:newsletter_edition_send_statistic.tpl'}

    {* Newsletter preview iframes *}
    {include uri='design:newsletter_edition_preview_archive.tpl'}

{else}
    {* Newsletter preview iframes *}
    {include uri='design:newsletter_edition_preview.tpl'}
{/if}
