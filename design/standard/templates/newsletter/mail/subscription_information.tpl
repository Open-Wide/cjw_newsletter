{*?template charset=utf-8?*}{set-block variable=$subject scope=root}{ezini('NewsletterMailSettings', 'EmailSubjectPrefix', 'newsletter.ini')} {'Subscription information'|i18n( 'newsletter/subscription_information' )}{/set-block}
{*
$newsletter_user
$hostname
*}
...
%configureLink
'|i18n( 'newsletter/mail/subscription_information',,
