...
<div class="newsletter newsletter-subscribe_success">
    ...
    <p>
        {'An email was sent to your address %email.'|i18n('newsletter/subscribe_success',, hash( '%email' , $newsletter_user.email ) ) }
    </p>
    <p>
        {'Please note that your subscription is only active if you clicked confirmation link in these email.'|i18n( 'newsletter/subscribe_success' )}
        <br />
        {'You have the possibility of changing your personal profile at any time.'|i18n( 'newsletter/subscribe_success' )}
    </p>
