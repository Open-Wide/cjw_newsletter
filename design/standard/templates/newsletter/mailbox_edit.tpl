                                ...
                                <div class="box-tr">
                                    <h1 class="context-title">
                                        {if is_set( $mailbox.email )}
                                            {$mailbox.email|class_icon( normal, $mailbox.email )}&nbsp;{'Edit <%mailbox.email> '|i18n( 'newsletter/mailbox_edit',, hash( '%mailbox.email', $mailbox.email ) )|wash}
                                        {else}
                                            {'Add new mail account'|i18n( 'newsletter/mailbox_edit' )}
                                        {/if}
                                    </h1>
                ...
                <div class="box-mr">
                    <div class="box-content">
                        <div class="context-attributes">
                            <label>{'Email'|i18n( 'newsletter/mailbox_edit' )}</label>
                            <input type="text" name="email" value="{$mailbox.email}" />
                            <label>{'Server'|i18n( 'newsletter/mailbox_edit' )}</label>
                            <input type="text" name="server" value="{$mailbox.server}" />
                            <label>{'Port'|i18n( 'newsletter/mailbox_edit' )}</label>
                            <input type="text" name="port" value="{$mailbox.port}" />
                            <label>{'User'|i18n( 'newsletter/mailbox_edit' )}</label>
                            <input type="text" name="user_name" value="{$mailbox.user_name}" />
                            <label>{'Password'|i18n( 'newsletter/mailbox_edit' )}</label>
                            <input type="password" name="password" value="{$mailbox.password}" />
                            <label>{'Type'|i18n( 'newsletter/mailbox_edit' )}</label>
                            <p>
                            ...
                            <label>{'SSL'|i18n( 'newsletter/mailbox_edit' )}</label>
                            <p>
                            ...
                            <label>{'Delete mails from server'|i18n( 'newsletter/mailbox_edit' )}</label>
                            <p>
                            ...
                            <label>{'Active'|i18n( 'newsletter/mailbox_edit' )}</label>
                            <p>
                        ...
                        <div class="box-mr">
                            <div class="box-tc">
                                <div class="box-bl">
                                    <div class="box-br">
                                        <div class="block">
                                            <input class="button" type="submit" name="PublishButton" value="{'Store Changes'|i18n( 'newsletter/mailbox_edit' )}" />
                                            <input type="hidden" name="edit" value="true" />
                                            <input type="hidden" name="redirect" value="{$view_parameters.redirect}" />
                                            <input class="button" type="submit" name="DiscardButton" value="{'Discard'|i18n( 'newsletter/mailbox_edit' )}" />
                                        </div>
