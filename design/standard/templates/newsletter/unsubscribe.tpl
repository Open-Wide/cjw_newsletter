...
you have to confirm this page.'|i18n( 'newsletter/unsubscribe','',
    ...
    <form method="post" action={concat('newsletter/unsubscribe/', $subscription.hash)|ezurl}>
        ...
        <input class="button" type="submit" name="SubscribeButton" value="{'Unsubscribe'|i18n( 'newsletter/unsubscribe' )}" title="{'Unsubscribe from list.'|i18n( 'newsletter/unsubscribe' )}" />
