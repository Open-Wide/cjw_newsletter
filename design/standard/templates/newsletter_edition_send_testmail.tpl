...
<h2 class="context-title">{"Send Test Newsletter at"|i18n("newsletter/send")}: 'test1@example.com;test2@example.com'</h2>
    ...
    <div class="box-bc"><div class="box-ml"><div class="box-mr"><div class="box-tc"><div class="box-bl"><div class="box-br">
        ...
        <div class="block">
            <div class="left">
                ...
                <input type="submit" class="button" name="SendNewsletterTestButton" value="{"Send Test Newsletter"|i18n("newsletter/send")}" />
