...
<form action={'content/action'|ezurl()} name="CreateNewNewsletterEdition" method="post">
    ...
    <input class="defaultbutton" type="submit" name="NewButton" value="{'Create newsletter here'|i18n( 'newsletter/newsletter_list' )}" />
</form>
{else}
<input class="button-disabled" type="button" name="NewButton" value="{'Create newsletter here'|i18n( 'newsletter/newsletter_list' )}" />
{/if}
...
<form name="CreateNewNewsletterUser" method="post" style="display:inline;" action={'newsletter/user_create'|ezurl}>
    ...
    <input class="button" type="submit" name="NewSubscriptionButton" value="{'Create new Subscription'|i18n( 'newsletter/subscription_list' )}" />
</form>
</div>
