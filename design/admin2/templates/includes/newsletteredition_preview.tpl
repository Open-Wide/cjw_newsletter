...
<p><a href={$src_url|ezurl} target="new_{$output_format_id}"> [{'Fullscreen'|i18n('newsletter/newsletteredition_preview')}]</a> - {*{'Preview'|i18n('newsletter/newsletteredition_preview')} "{$output_format_name}" - *}{'Skin'|i18n('newsletter/newsletteredition_preview')}: {$skin_name}</p>
