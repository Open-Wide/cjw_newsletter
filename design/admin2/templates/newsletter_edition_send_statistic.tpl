...
<div class="context-block">
<h2 class="context-title">{'Newsletter processing info'|i18n( 'newsletter/newsletter_edition_send_statistic' )}</h2>
...
<th width="1%">{* only show abort button if not  finished (3) or aborted (9) *}
            ...
            {else}
                ...
                <input type="button" class="button" value="{'Abort cronjob'|i18n( 'newsletter/newsletter_edition_send_statistic' )}" />
                </a>
