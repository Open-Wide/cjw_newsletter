...
<div class="button-right">
    ...
    {if $status|eq('')}
        <span class="current">{'All'|i18n('newsletter/newsletter_list')}</span>
    {else}
        <a href={concat( $node.url_alias,'')|ezurl}>
            {'All'|i18n('newsletter/newsletter_list')}
        </a>
    {/if}

    {if $status|eq('draft')}
        <span class="current"><img src={'images/newsletter/icons/crystal-newsletter/16x16/newsletter_draft.png'|ezdesign} width="12" height="12" /> {'Draft'|i18n('newsletter/contentstructuremenu')}</span>
    {else}
        <a href={concat( $node.url_alias, '/(status)/draft' )|ezurl}>
            <img src={'images/newsletter/icons/crystal-newsletter/16x16/newsletter_draft.png'|ezdesign} width="12" height="12" /> {'Draft'|i18n('newsletter/contentstructuremenu')}
        </a>
    {/if}

    {if $status|eq('process')}
        <span class="current"><img src={'images/newsletter/icons/crystal-newsletter/16x16/newsletter_process.png'|ezdesign} width="12" height="12" /> {'Sending'|i18n('newsletter/contentstructuremenu')}</span>
    {else}
        <a href={concat( $node.url_alias, '/(status)/process' )|ezurl}>
            <img src={'images/newsletter/icons/crystal-newsletter/16x16/newsletter_process.png'|ezdesign} width="12" height="12" /> {'Sending'|i18n('newsletter/contentstructuremenu')}
        </a>
    {/if}

    {if $status|eq('archive')}
        <span class="current"><img src={'images/newsletter/icons/crystal-newsletter/16x16/newsletter_archive.png'|ezdesign} width="12" height="12" /> {'Archived'|i18n('newsletter/contentstructuremenu')}</span>
    {else}
        <a href={concat( $node.url_alias, '/(status)/archive' )|ezurl}>
            <img src={'images/newsletter/icons/crystal-newsletter/16x16/newsletter_archive.png'|ezdesign} width="12" height="12" /> {'Archived'|i18n('newsletter/contentstructuremenu')}
        </a>
    {/if}

    {if $status|eq('abort')}
        <span class="current"><img src={'images/newsletter/icons/crystal-newsletter/16x16/newsletter_abort.png'|ezdesign} width="12" height="12" /> {'Aborted'|i18n('newsletter/contentstructuremenu')}</span>
    {else}
        <a href={concat( $node.url_alias, '/(status)/abort' )|ezurl}>
            <img src={'images/newsletter/icons/crystal-newsletter/16x16/newsletter_abort.png'|ezdesign} width="12" height="12" /> {'Aborted'|i18n('newsletter/contentstructuremenu')}
        </a>
    {/if}
    </p>
</div>
...
<div class="block">
    <p>{'The current selection has no result.'|i18n( 'newsletter/newsletter_list' )}</p>
</div>
